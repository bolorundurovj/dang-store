...
function autocomplete(input, latInput, lngInput) {
    ...
    dropdown.addListener('place-changed', function () {
...
function loadPlaces(map) {
    ...
    _axios.axios.get("/api/stores/near?lat=" + lat + "&lng=" + lng).then(function (res) {
        var places = res.data;
        if (!places.length) {
        ...
        //zoom the map to fit the markers perfectly
